...
class CambiarEstadoComanda():
    def __init__(self):
        ...
        self.ventanaCliente.title("Cambiar Estado Comanda")
        
        #Titulo principal
        self.lblTituloPrincipal = Label(self.ventanaCliente, text="Cambiar Estado Comanda", font=("Arial", 15))
        ...
        img_Cambiar = PhotoImage(file=r"icons\carta.png").subsample(16) 
        ...
        self.btnCambiar = Button(self.ventanaCliente, image = img_Cambiar, command=self.enviar_comanda)
        self.btnCambiar.place(x=180, y=430, height=40, width=150)
        self.btnCambiar.image = img_Cambiar
        self.create_tooltip(self.btnCambiar, "Cambiar estado")
    ...
    def enviar_comanda(self):
        ...
        try:
            ...
            if comanda_existente:
                # Cambiar el estado a 'Servido'
                consulta_update = "UPDATE comanda SET estado = %s WHERE id = %s"
                cursor.execute(consulta_update, ('Servido', id))

                con.commit()
                messagebox.showinfo("Éxito", "Comanda enviada a Servido.")
            else:
    ...
    def buscar_comanda(self):
        ...
        try:
            ...
            consulta_busqueda = "SELECT cedula_cliente, mesa, platos, precio_total, estado FROM comanda WHERE id = %s"
            ...
            if comanda:
                ...
                self.txtPrecio_total.insert(0, comanda[3])
