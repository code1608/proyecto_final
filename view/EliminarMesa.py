...
from controller.Funciones import eliminar_mesa
...
class EliminarMesa():
    def __init__(self):
        ...
        self.ventanaCliente.title("Eliminar Mesa")
        
        #Titulo principal
        self.lblTituloPrincipal = Label(self.ventanaCliente, text="Eliminar Mesa", font=("Arial", 15))
        ...
        #Boton Guardar
        self.btnEliminar = Button(self.ventanaCliente, image = img_eliminar, command=self.eliminar_mesa)
        self.btnEliminar.place(x=205, y=270, height=40, width=110)
        self.btnEliminar.image = img_eliminar
        self.create_tooltip(self.btnEliminar, "Eliminar Mesa")
    ...
    def eliminar_mesa(self):
        ...
        if not id and not cantidad_comensales and not estado:
            messagebox.showwarning("Advertencia", "Por favor, ingrese al menos un dato para buscar")
            return

        try:
            # Llama a la función eliminar_mesa con los datos
            eliminar_mesa(id, cantidad_comensales, estado)
            ...
            messagebox.showerror("Error", f"Ocurrió un error al buscar/eliminar la mesa: {e}")

    #funcion para buscar la mesa
    def buscar_mesa(self):
        ...
        try:
            ...
            if resultado:
                ...
                messagebox.showwarning("Advertencia", "No se encontró una mesa con el id proporcionado")
